...
import { getOrganizationStats } from '../../../services/organization';

export interface IOrganizationStatsProps { }

const OrganizationStats: React.FunctionComponent<IOrganizationStatsProps> = props => {
